...
async def add_watermark(video_path, user_id, progress_message):
    ...
    try:
        ...
        command = [
            ...
            '-c:v', 'libx264', '-crf', '18',  # Use CRF 18 for high quality
        ...
        await progress_message.edit_text("Watermark added successfully!")
...
async def handle_video(client, message: Message):
    ...
    if final_video_path is None:
        ...
        await progress_message.edit("Watermarking completed! Uploading the video...")
